            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('dashboard.products.update', $product->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <img src="{{ $product->image_path }}"  style="width: 100px" class="img-thumbnail image-preview" alt="@lang('site.image')">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <a href="{{ route('dashboard.products.index') }}" class="btn btn-primary"><i class="fa fa-backward"></i> @lang('site.back')</a>
                        </div>
